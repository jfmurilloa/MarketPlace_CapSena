"""
URL configuration for ProyectoMarket project.
...
from ProyectoMarket.views import *
...
urlpatterns = [
    ...
    path('Proveedor/eliminar',EliminarProveedor),
    path('Producto/insertar',InsertarProducto),
    path('Producto/listado',ListadoProductos),
